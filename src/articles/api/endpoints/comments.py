...
async def create_comment(*, db: DbSession, comment_in: CommentCreate) -> Any:
...
async def update_comment(*, db: DbSession, comment_id: int, comment_in: CommentUpdate) -> Any:
    comment_service = CommentService(db)
...
async def delete_comment(*, db: DbSession, comment_id: int) -> Any:
    comment_service = CommentService(db)
